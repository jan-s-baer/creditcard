...
console.log(findInvalidCards([valid1, valid2, valid3, valid4, valid5])); // Shouldn't print at all
console.log(findInvalidCards([invalid1, invalid2, invalid3, invalid4, invalid5])); // Should print all card numbers
...
console.log(idInvalidCardCompanies(batch)); // Find out which companies mailed invalid cards
